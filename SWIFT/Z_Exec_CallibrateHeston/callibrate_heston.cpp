...
//    std::vector<std::vector<double>> K_over_S = {{0.9371, 0.9956, 1.0427, 1.2287, 1.3939, 0.8603, 0.9868, 1.0463, 1.2399, 1.4102, 0.8112, 0.9728, 1.0499, 1.2485, 1.4291, 0.7760, 0.9588, 1.0530, 1.2659, 1.4456, 0.7470, 0.9464, 1.0562, 1.2646, 1.4603, 0.7216, 0.9358, 1.0593, 1.2715, 1.4736, 0.6699, 0.9175, 1.0663, 1.2859, 1.5005, 0.6137, 0.9025, 1.0766, 1.3046, 1.5328}};
    ...
    if (argc >=2 && std::string(*(argv+1)) == "test"&&std::string(*(argv+2)) == "full"){
    ...
    //    p[4] = 0.2000;
            ...
            double p[5];
            p[0] = kappa+.2; //* (1.0 + (((double) rand() / (RAND_MAX)) - 0.5) / 5);
            p[1] = v_bar+.2; //* (1.0 + (((double) rand() / (RAND_MAX)) - 0.5) / 5);
            p[2] = sigma+.2; //* (1.0 + (((double) rand() / (RAND_MAX)) - 0.5) / 5);
            p[3] = rho+.2; //* (1.0 + (((double) rand() / (RAND_MAX)) - 0.5) / 5);
            p[4] = v0+.2; //* (1.0 + (((double) rand() / (RAND_MAX)) - 0.5) / 5);
    ...
    } else if (argc >=2 && std::string(*(argv+1)) == "test"&&std::string(*(argv+2)) == "pricing"){
